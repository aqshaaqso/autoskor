...
const btnPrimary =
  'inline-flex items-center justify-center gap-2 rounded-lg bg-primary-600 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-60'

const btnGhost =
  'inline-flex items-center justify-center gap-2 rounded-lg bg-transparent px-3 py-1.5 text-sm font-medium text-slate-600 transition-colors hover:bg-slate-100 focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2'
  ...
  return h(
    ...
    h(
      ...
      h(
        'div',
        null,
        h('p', { className: 'font-medium text-slate-800' }, file.name),
        h('p', { className: 'text-sm text-slate-500' }, formatFileSize(file.size)),
      ),
    ),
    h(
      'div',
  ...
  return h(
    ...
    h(
      ...
      h(
        ...
        isDragActive ? 'Lepaskan file di sini...' : 'Drag & drop dokumen di sini',
      ),
      h(
        'p',
      ...
      h(
        ...
        'Format yang didukung: PDF, JPG, PNG, WEBP (maks. 1 file)',
      ),
    ),
    currentFile &&
      !isProcessing &&
    ...
    error &&
      h(
        ...
        h(
          'div',
          null,
          h('p', { className: 'font-medium text-danger-800' }, 'Terjadi Kesalahan'),
